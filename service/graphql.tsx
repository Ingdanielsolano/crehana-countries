...
export type GetAllCountriesQueryVariables = Exact<{
  countryFilters?: InputMaybe<CountryFilterInput>;
}>;


export type GetAllCountriesQuery = { __typename?: 'Query', countries: Array<{ __typename?: 'Country', code: string, name: string, native: string, phone: string, capital?: string | null, currency?: string | null, emoji: string, emojiU: string, continent: { __typename?: 'Continent', code: string, name: string }, languages: Array<{ __typename?: 'Language', code: string, name?: string | null, native?: string | null, rtl: boolean }>, states: Array<{ __typename?: 'State', code?: string | null, name: string }> }> };
