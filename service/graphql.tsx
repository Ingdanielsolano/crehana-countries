...
export type GetAllContinentsQuery = {
  __typename?: "Query";
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "countryFilters" },
          },
          type: {
            kind: "NamedType",
...
export const GetAllContinentsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetAllContinents" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  GetAllContinentsQueryVariables
>;
